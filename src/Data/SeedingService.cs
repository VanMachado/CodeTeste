...
namespace CodeChallenge.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Client p1 = new Client("Poco Yo", "pocoyo@gmail.com", "11996457858", Tipo.Juridica, "01123123000114", false, "012345678912");
            Client p2 = new Client("Maria Silva", "maria@gmail.com", "11987654321", Tipo.Fisica, "98765432198", true, Genero.Feminino, new DateTime(1990, 3, 15), false, "senha123");
            Client p3 = new Client("Empresa XYZ LTDA", "contato@empresa.xyz", "1112345678", Tipo.Juridica, "0154962192654", false, "112233440001");
            Client p4 = new Client("João Oliveira", "joao.oliveira@gmail.com", "11987651234", Tipo.Fisica, "12345678912", false, Genero.Masculino, new DateTime(1985, 7, 20), false, "abcd1234");
            Client p5 = new Client("Fernanda Santos", "fernanda.santos@gmail.com", "11987659876", Tipo.Fisica, "98765432123", true, Genero.Feminino, new DateTime(1978, 9, 10), true, "senha456");
            ...
            Client p8 = new Client("Empresa EFG Ltda", "contato@empresaefg.com", "1143218765", Tipo.Juridica, "13579246802468", false, "123456789012");
            ...
            Client p13 = new Client("Empresa UVW Ltda", "contato@empresauvw.com", "1143218765", Tipo.Juridica, "25896314702584", false, "789456123012");
